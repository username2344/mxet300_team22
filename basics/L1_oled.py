...
def getVoltage():
    ...
    ##########################################
    botVolt = str(voltstuff.readVolts())
    return botVolt# Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Felix", font=font, fill=255)
    ...
    draw.text((0,40), "Felix Voltage: " + getVoltage()+"V", font=font, fill=225)
