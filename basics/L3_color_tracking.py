...
target_width = 124      # Target pixel width of tracked object
...
def main():
    ...
    try:
        while True:
            ...
            if len(cnts) and len(cnts):                             # If more than 0 and less than 3 closed shapes exist
